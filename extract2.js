            ...
            if (step.tool_calls) {
                for (const call of step.tool_calls) {
                    if (call.name === 'default_api:write_to_file') {
                        if (call.arguments && call.arguments.TargetFile && call.arguments.TargetFile.includes('ProjectDetail.jsx')) {
                            console.log("FOUND WRITE_TO_FILE for ProjectDetail.jsx!");
                            fs.writeFileSync('restored_ProjectDetail.jsx', call.arguments.CodeContent);
                        }
                    }
                }
            }
